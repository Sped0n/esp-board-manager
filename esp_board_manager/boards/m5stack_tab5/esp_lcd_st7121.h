 ...
 */
typedef struct {
    const st7121_lcd_init_cmd_t *init_cmds;         /*!< Pointer to initialization commands array. Set to NULL if using default commands.
 ...
 *      - Otherwise             on fail
 */
esp_err_t esp_lcd_new_panel_st7121(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config,
